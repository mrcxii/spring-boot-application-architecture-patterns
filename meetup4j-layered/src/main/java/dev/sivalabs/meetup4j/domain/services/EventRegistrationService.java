...
import dev.sivalabs.meetup4j.domain.events.RegistrationAdded;
import dev.sivalabs.meetup4j.domain.events.RegistrationCancelled;
import dev.sivalabs.meetup4j.domain.exceptions.RegistrationCancellationException;
import dev.sivalabs.meetup4j.domain.models.*;
import dev.sivalabs.meetup4j.domain.repositories.RegistrationRepository;
